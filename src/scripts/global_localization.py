...
def global_localization(pose_estimation):
    ...
    transformation, fitness = registration_at_scale(scan_tobe_mapped, global_map, initial=pose_estimation,
                                                    scale=1)
    toc = time.time()
...
def initialize_global_map(pc_msg):
    ...
    #o3d.visualization.draw_geometries([global_map]) #测试数据读取
...
if __name__ == '__main__':
    ...
    while not initialized:
        ...
        #rospy.logwarn('Get initial pose....')
        if cur_scan:
